...
PLUGINS = ["nautobot_ipfdemo_plugin", "nautobot_capacity_metrics", "nautobot_ssot", "nautobot_ssot_ipfabric", "nautobot_chatops", "nautobot_chatops_ipfabric"]

# Plugins configuration settings. These settings are used by various plugins that the user may have installed.
# Each key in the dictionary is the name of an installed plugin and its value is a dictionary of settings.
PLUGINS_CONFIG = {
    "nautobot_ipfdemo_plugin": {"static_root_url": os.environ.get("STATIC_ROOT_URL", "http://localhost:8080")},
